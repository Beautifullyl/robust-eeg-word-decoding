...
def main() -> int:
    ...
    summary_csv = args.output_dir / "workflow12_fixed_session_channel_loss_summary.csv"
    subjects_csv = args.output_dir / "workflow12_fixed_session_channel_loss_subjects.csv"
