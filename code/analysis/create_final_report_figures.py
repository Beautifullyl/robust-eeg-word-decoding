...
def main() -> int:
    ...
    random_rows = read_csv("workflow12_fixed_session_channel_loss_summary.csv")
    matched_condition_rows = read_csv("workflow13_matched_fixation_conditions.csv")
    matched_paired_rows = read_csv("workflow13_matched_fixation_paired_comparisons.csv")
