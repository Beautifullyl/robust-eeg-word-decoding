...
def main() -> int:
    ...
    write_csv(args.output_dir / "workflow10_grouped_validation_comparison.csv", comparison_rows)
    write_csv(args.output_dir / "workflow10_grouped_validation_subjects.csv", subject_rows)
    payload = {
        "method": (
