...
def main() -> int:
    ...
    write_csv(args.output_dir / "workflow14_repeated_sentence_partitions_runs.csv", run_rows)
    write_csv(args.output_dir / "workflow14_repeated_sentence_partitions_subjects.csv", subject_rows)
    write_csv(args.output_dir / "workflow14_repeated_sentence_partitions_folds.csv", fold_rows)
